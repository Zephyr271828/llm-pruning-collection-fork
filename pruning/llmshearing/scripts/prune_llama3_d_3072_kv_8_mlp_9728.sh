...
#SBATCH --job-name=prune_llama3_d_3072_kv_8_mlp_9728_%j
#SBATCH --output=logs/prune_llama3_d_3072_kv_8_mlp_9728_%j.out
#SBATCH --error=logs/prune_llama3_d_3072_kv_8_mlp_9728_%j.err
...
target_d_model=3072; target_n_heads=32; target_n_kv_heads=8; target_n_layers=32; target_intermediate_size=9728
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.intermediate_size=9728
