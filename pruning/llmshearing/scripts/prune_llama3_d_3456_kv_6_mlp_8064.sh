...
#SBATCH --job-name=prune_llama3_d_3456_kv_6_mlp_8064_%j
#SBATCH --output=logs/prune_llama3_d_3456_kv_6_mlp_8064_%j.out
#SBATCH --error=logs/prune_llama3_d_3456_kv_6_mlp_8064_%j.err
...
update_type=doremi
target_loss=[2.2413,0.8228,2.2408,1.8670,1.6770,1.2731,2.3719]
...
target_d_model=3456; target_n_heads=24; target_n_kv_heads=6; target_n_layers=32; target_intermediate_size=8064
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.intermediate_size=8064
