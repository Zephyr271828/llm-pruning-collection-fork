...
from fms.modules.linear import register_linear_type_to_module_map
...
_7b_config = LLaMAConfig(norm_eps=1e-6)
_2_7b_config = LLaMAConfig()
...
_3_4b_depth_config = LLaMAConfig(
    src_vocab_size=128256,
    emb_dim=4096,
    norm_eps=1e-5,
    nheads=32,
...
_3_4b_width_config = LLaMAConfig(
    src_vocab_size=128256,
    emb_dim=3072,
    norm_eps=1e-5,
    nheads=32,
...
# LLama 2 family
models.register_model(_architecture_name, "2-7b", _llama_factory_factory(_2_7b_config))
...
models.register_model(
    _architecture_name, "3-4b-depth", _llama_factory_factory((_3_4b_depth_config))
)
models.register_model(
    _architecture_name, "3-4b-width", _llama_factory_factory((_3_4b_width_config))
)
models.register_model(
    _architecture_name, "3-1b", _llama_factory_factory((_1b_config))
)
