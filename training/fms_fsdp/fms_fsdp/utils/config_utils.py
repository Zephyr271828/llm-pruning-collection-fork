...
def get_model_config(model_variant):
    ...
    elif model_variant == "llama2_1.3b":
        model_config = LLaMAConfig(
            emb_dim=2048,
            nheads=16,
            kvheads=16,
            nlayers=24,
            hidden_grow_factor=5504 / 2048,
            multiple_of=None,
        )
    elif model_variant == "llama2_2.7b":
        model_config = LLaMAConfig(
            emb_dim=2560,
            nheads=20,
            kvheads=20,
            nlayers=32,
            hidden_grow_factor=6912 / 2560,
            multiple_of=None,
        )
    elif model_variant == "llama3.1_440m":
        model_config = LLaMAConfig(
    ...
    elif model_variant == "llama3_4b_depth":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=4096,
            nheads=32,
    ...
    elif model_variant == "llama3.1_1b":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=2048,
            head_dim=128,
    ...
    elif model_variant == "llama3_4b_width":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=3072,
            head_dim=128,
