...
target_d_model=3072; target_n_heads=16; target_n_kv_heads=4; target_n_layers=32; target_intermediate_size=10112
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.intermediate_size=10112
