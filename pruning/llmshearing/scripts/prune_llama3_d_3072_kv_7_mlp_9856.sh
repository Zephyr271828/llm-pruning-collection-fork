...
#SBATCH --job-name=prune_llama3_d_3072_kv_7_mlp_9856_%j
#SBATCH --output=logs/prune_llama3_d_3072_kv_7_mlp_9856_%j.out
#SBATCH --error=logs/prune_llama3_d_3072_kv_7_mlp_9856_%j.err
...
update_type=doremi
target_loss=[2.2423,0.8234,2.2419,1.8679,1.6780,1.2737,2.3728]
...
target_d_model=3072; target_n_heads=28; target_n_kv_heads=7; target_n_layers=32; target_intermediate_size=9856
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.n_heads=28
    model.l0_module.target_model.n_kv_heads=7
    model.l0_module.target_model.n_layers=32
    model.l0_module.target_model.intermediate_size=9856
