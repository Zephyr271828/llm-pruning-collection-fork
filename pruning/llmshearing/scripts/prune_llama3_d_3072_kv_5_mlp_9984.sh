...
#SBATCH --job-name=prune_llama3_d_3072_kv_5_mlp_9984_%j
#SBATCH --output=logs/prune_llama3_d_3072_kv_5_mlp_9984_%j.out
#SBATCH --error=logs/prune_llama3_d_3072_kv_5_mlp_9984_%j.err
