...
#SBATCH --job-name=prune_llama3_d_3456_kv_5_mlp_8064_%j
#SBATCH --output=logs/prune_llama3_d_3456_kv_5_mlp_8064_%j.out
#SBATCH --error=logs/prune_llama3_d_3456_kv_5_mlp_8064_%j.err
...
target_d_model=3456; target_n_heads=20; target_n_kv_heads=5; target_n_layers=32; target_intermediate_size=8064
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.n_heads=20
    model.l0_module.target_model.n_kv_heads=5
