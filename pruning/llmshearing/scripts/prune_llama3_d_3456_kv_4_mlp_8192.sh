...
#SBATCH --job-name=prune_llama3_d_3456_kv_4_mlp_8192_%j
#SBATCH --output=logs/prune_llama3_d_3456_kv_4_mlp_8192_%j.out
#SBATCH --error=logs/prune_llama3_d_3456_kv_4_mlp_8192_%j.err
...
update_type=doremi
target_loss=[2.2420,0.8232,2.2415,1.8676,1.6777,1.2735,2.3725]
...
target_d_model=3456; target_n_heads=16; target_n_kv_heads=4; target_n_layers=32; target_intermediate_size=8192
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.n_heads=16
    model.l0_module.target_model.n_kv_heads=4
    model.l0_module.target_model.n_layers=32
    model.l0_module.target_model.intermediate_size=8192
