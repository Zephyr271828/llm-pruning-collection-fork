...
#SBATCH --job-name=prune_llama3_d_3456_kv_7_mlp_7936_%j
#SBATCH --output=logs/prune_llama3_d_3456_kv_7_mlp_7936_%j.out
#SBATCH --error=logs/prune_llama3_d_3456_kv_7_mlp_7936_%j.err
...
target_d_model=3456; target_n_heads=28; target_n_kv_heads=7; target_n_layers=32; target_intermediate_size=7936
...
SCRIPT_ARGS=(
    ...
    model.l0_module.target_model.intermediate_size=7936
